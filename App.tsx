...
import { Home, Map, Compass, MessageSquare, User, Bell, Search, AlertTriangle, Navigation as NavIcon, ChevronLeft, ChevronRight, Mail, Shield, Eye, MapPin, Pencil, Save, X, Clock, Cloud, CloudRain, CloudLightning, Sun, CloudSun, Heart, Phone, Trash2, Plus, UserPlus } from 'lucide-react';
...
const MainApp: React.FC = () => {
  ...
  const [personalContacts, setPersonalContacts] = useState<PersonalContact[]>([
      { id: '1', name: 'Mom', number: '0917-123-4567', relation: 'Family' },
      { id: '2', name: 'Partner', number: '0918-987-6543', relation: 'Family' }
  ]);
  ...
  return (
    <div className="w-full h-full max-w-md bg-gray-50 mx-auto shadow-2xl relative flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto scrollbar-hide">
        {selectedAttraction ? (
          ...
          <>
            ...
            {currentTab === AppTab.AI_GUIDE && <ChatAssistant />}
      ...
      <div className={`h-[80px] bg-white border-t border-gray-200 flex justify-between items-start px-2 py-3 shrink-0 z-30 transition-transform duration-300 ${selectedAttraction ? 'translate-y-full hidden' : ''}`}>
        ...
        <TabButton tab={AppTab.AI_GUIDE} icon={MessageSquare} label="AI Guide" />
