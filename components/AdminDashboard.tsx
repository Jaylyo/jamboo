...
import { Users, AlertTriangle, Activity, Settings, BarChart3, LogOut, Search, UserCheck, Shield, Plus, X, Bell, CheckCircle2, Clock, User, Filter, Radio, Building2, Trash2 } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: 'Maria Santos', email: 'm.santos@email.com', role: 'Responder', status: 'Active' },
    { id: 2, name: 'John Doe', email: 'tourist1@email.com', role: 'Tourist', status: 'Active' },
    { id: 3, name: 'Staff User', email: 'staff@cebusafe.com', role: 'Staff', status: 'Active' },
    { id: 4, name: 'Jane Smith', email: 'jane.s@email.com', role: 'Tourist', status: 'Suspended' },
    { id: 5, name: 'Admin User', email: 'admin@cebu.gov', role: 'Admin', status: 'Active' },
  ]);
            ...
            <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-800 p-4 rounded-xl border border-slate-700">
                    ...
                    <div className="text-[10px] text-green-500 mt-2">+12% this week</div>
                  </div>
                  <div className="bg-slate-800 p-4 rounded-xl border border-slate-700">
